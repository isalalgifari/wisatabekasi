             ...
             <div id="WJSlider" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <img src="gambar/wisata bahari/hm1.jpg" alt="slide1" width="100" height="100">
                ...
                <div class="item">
                  <img src="gambar/wisata bahari/hm2.jpg" alt="slide2" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>HUTAN MANGROVE</h3>
                    <p>Muara Gembong</p>
                  </div>
                ...
                <div class="item">
                  <img src="gambar/wisata bahari/hm3.jpg" alt="slide3" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>HUTAN MANGROVE</h3>
                    <p>Muara Gembong</p>
                  </div>
                ...
                <div class="item">
                  <img src="gambar/wisata bahari/hm4.JPG" alt="slide4" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>HUTAN MANGROVE</h3>
                    <p>Muara Gembong</p>
                  </div>
          ...
          <div id="c">
            <div id =kiri class="col-md-6">
              ...
              <div id=tiket>
                ...
                <div id=div2 style="display:none;"><p>Paket liburan (jelajah dengan sampan + bakar ikan) = Rp 70.000 /orang</p></div>
                <div id=div3 style="display:none;"><p>Sewa perahu kapasitas 40 orang= Rp 400.000</p></div>
                <div id=div4 style="display:none;"><p>Parkir motor = Rp 2.000</p></div>
                <div id=div5 style="display:none;"><p>Parkir mobil = Rp 3.000</p></div>
                <div id=div6 style="display:none;"><p>Jam buka = 8:00 s.d 17:00 WIB</p></div>
              </div>
              ...
              <div id="panel">
                <p>Kalau Jakarta punya Taman Wisata Alam Mangrove Angke Kapuk, maka Bekasi punya Muara Gembong. Hutan mangrove ini sangat indah dan masih alami. Inilah paras cantik Bekasi yang warganya sendiri mungkin belum tahu.</p>
                <p>Muara Gembong itu, sebenarnya merupakan nama kecamatan yang berlokasi di Kabupaten Bekasi. Di dalamnya ada enam desa yaitu Desa Pantai Bahagia, Pantai Mekar, Pantai Sederhana, Pantai Harapan Jaya, Desa Pantai Bakti, Desa Jaya Sakti. Jarak dari pusat Kota Bekasi ke sana, sekitar 70 kilometer atau naik mobil ditempuh dengan waktu 2 jam.</p>
                <p>Hutan mangrove di Muara Gembong panjangnya sekitar 17 kilometer, sangat luas. Di beberapa titik, pohon bakaunya besar-besar. Meski ada yang sudah rusak, tapi lainnya masih banyak yang alami</p>
                <p>Soal pemandangan, hutan mangrove di Muara Gembong bak seperti di Kalimantan. Sambil naik perahu sampan, pengunjung akan mengarungi sungai dengan pepohonan bakau di kanan dan kiri. Tanpa ada polusi, lalu lalang orang lain hingga suara kendaraan, benar-benar serasa di alam liar.</p>
              </div>
            <br>
            </div>
            ...
            <div id =kanan class="col-md-6">
              <br>
              <form id="formkomentar" action="input hm.php" method="post">
                <div>
            ...
            <div id=bawah class="col-md-12">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126975.97133903197!2d106.98108050483627!3d-5.994856053287025!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6a24e2df102353%3A0x297fc571aa5ce5d6!2sMuara+Gembong%2C+Bekasi%2C+Jawa+Barat!5e0!3m2!1sid!2sid!4v1499727974348" width="700" height="400" frameborder="0" style="border:0" allowfullscreen></iframe></h2>
            </div>
          </div>
