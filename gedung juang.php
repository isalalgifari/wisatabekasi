             ...
             <div id="WJSlider" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <img src="gambar/wisata sejarah/gj1.jpg" alt="slide1" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>GEDUNG JUANG</h3>
                    <p>Setiadarma, Kecamatan Tambun Selatan</p>
                  </div>
                </div>

                <div class="item">
                  <img src="gambar/wisata sejarah/gj2.jpg" alt="slide2" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>GEDUNG JUANG</h3>
                    <p>Setiadarma, Kecamatan Tambun Selatan</p>
                  </div>
                ...
                <div class="item">
                  <img src="gambar/wisata sejarah/gj3.jpg" alt="slide3" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>GEDUNG JUANG</h3>
                    <p>Setiadarma, Kecamatan Tambun Selatan</p>
                  </div>
        ...
        <div class="container">
          <div id="c">
            <div id =kiri class="col-md-6">
              ...
              <div id="panel">
                <p>Gedung Juang Tambun adalah sebuah situs sejarah yang terletak di kecamatan Tambun Selatan, Kabupaten Bekasi. Sebelum Revolusi Nasional, bangunan ini bernama Landhuis Tamboen atau Gedung Tinggi, dan merupakan pusat tanah partikelir milik keluarga Khouw van Tamboen.Gedung Juang Tambun dan stasiun Tambun yang telah dihancurkan yang terletak di belakang gedung ini, dua-duanya bergaya Art Deco dan merupakan satu kesatuan sejarah tidak terpisahkan.</p>
                <p>Gedung juang Tambun ini berlokasi hanya beberapa kilometer dari perbatasan wilayah terluar Batavia yaitu wilayah Sasak Jarang yang kini menjadi wilayah perbatasan antara kecamatan Bekasi Timur, kota Bekasi dengan kecamatan Tambun Selatan, Kabupaten Bekasi. Akibat pertahanan Belanda di wilayah Bekasi sering diserang, maka Belanda sering meninggalkan tempat pertahanannya di wilayah Bekasi dan menarik diri untuk memperkuat wilayah pertahanannya di Klender, yang kemudian menjadi batas antara kota Bekasi dengan Jakarta Timur.
                Relief perundingan pertukaran tawanan perang antara pejuang kemerdekaan Indonesia dengan tentara Belanda.</p>
                <p>Gedung ini juga menjadi tempat perundingan pertukaran tawanan antara Belanda dengan para pejuang kemerdekaan Indonesia. Pejuang kemerdekaan Indonesia dipulangkan oleh Belanda ke wilayah Bekasi dan tentara Belanda dipulangkan ke Batavia melalui Stasiun Tambun yang lintasan relnya tepat berada di belakang gedung ini.</p>
              </div>
            <br>
            </div>
            ...
            <div id =kanan class="col-md-6">
              <br>
              <form id="formkomentar" action="input gj.php" method="post">
                <div>
            ...
            <div id=bawah class="col-md-12">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.033998894214!2d107.05243111406838!3d-6.259251963021834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698fad4ec3519b%3A0x8571e006c1119397!2sGedung+Juang+Tambun!5e0!3m2!1sid!2sid!4v1527893783338" width="700" height="400" frameborder="0" style="border:0" allowfullscreen></iframe></h2>
            </div>
          </div>
