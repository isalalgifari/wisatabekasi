             ...
             <div id="WJSlider" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <img src="gambar/wisata bahari/pmb1.jpg" alt="slide1" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>PANTAI MUARA BETING</h3>
                    <p>Desa Pantai Bahagia, Kecamatan Muara Gembong</p>
                  </div>
                </div>

                <div class="item">
                  <img src="gambar/wisata bahari/pmb2.jpg" alt="slide2" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>PANTAI MUARA BETING</h3>
                    <p>Desa Pantai Bahagia, Kecamatan Muara Gembong</p>
                  </div>
                ...
                <div class="item">
                  <img src="gambar/wisata bahari/pmb3.jpg" alt="slide3" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>PANTAI MUARA BETING</h3>
                    <p>Desa Pantai Bahagia, Kecamatan Muara Gembong</p>
                  </div>
                ...
                <div class="item">
                  <img src="gambar/wisata bahari/pmb4.JPG" alt="slide4" width="100" height="100">
                  <div class="carousel-caption">
                    <h3>PANTAI MUARA BETING</h3>
                    <p>Desa Pantai Bahagia, Kecamatan Muara Gembong</p>
                  </div>
          ...
          <div id="c">
            <div id =kiri class="col-md-6">
              ...
              <div id=tiket>
                ...
                <div id=div2 style="display:none;"><p>Sewa perahu = Rp 20.000</p></div>
              ...
              <div id="panel">
                <p>Pantai Muara Beting terletak di Desa Pantai Bahagia, Kecamatan Muara Gembong, Kabupaten Bekasi, Provinsi Jawa Barat. Pantai ini merupakan destinasi favorit bagi keluarga Bekasi. Objek wisatanya sudah dilengkapi dengan berbagai sarana dan fasilitas untuk memudahkan pengunjung. Misalnya tempat parkir, kamar ganti, dan rumah makan.</p>
                <p>Di sini pengunjung juga dapat menikmati hutan bakau yang luas di pinggiran pantai dan di perairan. Tanaman yang juga disebut mangrove itu tumbuh di lahan seluas 70 Ha. Di dalamnya terdapat bermacam fauna seperti burung-burung lokal dan lutung hitam. Selain itu, ada pula wisata tambak. Masyarakat sekitar pantai juga menggantungkan hidup dari hasil budidaya tambak udang, ikan, dan rumput laut.</p>
              </div>
            <br>
            </div>
            ...
            <div id =kanan class="col-md-6">
              <br>
              <form id="formkomentar" action="input pmb.php" method="post">
                <div>
            ...
            <div id=bawah class="col-md-12">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3968.496961774644!2d107.04520259067682!3d-5.926006187203348!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6a3ba84de65d9b%3A0xadf8fbeae36d0616!2sPantai+Muara+Beting!5e0!3m2!1sid!2sid!4v1497169265996" width="700" height="400" frameborder="0" style="border:0" allowfullscreen></iframe></h2>
            </div>
          </div>
